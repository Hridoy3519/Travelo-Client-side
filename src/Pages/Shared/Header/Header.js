        ...
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link as={Link} to="/home#tours">Tour</Nav.Link>
            ...
            <Nav>
              {user.email ? (
                <div className="d-flex align-items-center justify-content-between">
                  <h5 className="colored-text me-3">
                    <i className="far fa-user"></i> {user.displayName}{" "}
                  </h5>
                  <button onClick={logOut} className="customized-btn">
                    Logout
                  </button>
                </div>
              ) : (
                <Nav.Link className="customized-btn" as={Link} to="/login">
                  Login
                </Nav.Link>
              )}
            </Nav>
